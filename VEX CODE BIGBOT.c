...
#pragma config(Motor,  port2,           leftDrive2,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           leftDrive1,    tmotorVex393_MC29, openLoop, reversed)
...
#pragma config(Motor,  port6,           pegLeft,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           pegRight,      tmotorVex393_MC29, openLoop)
...
task usercontrol()
{
  ...
  motor[launcherRight] = 127;
	...
	while (true)
	{
	  ...
	  motor[leftDrive1] = applyDeadzone(vexRT[Ch2], DRIVE_DZ);
	  motor[leftDrive2] = applyDeadzone(vexRT[Ch2], DRIVE_DZ);
	  motor[rightDrive1] = applyDeadzone(vexRT[Ch3], DRIVE_DZ);
	  motor[rightDrive2] = applyDeadzone(vexRT[Ch3], DRIVE_DZ);
	  ...
	  // Shoulder button for lowering pegs
	  if (vexRT[Btn5D] == 1)
	  {
	  	motor[pegLeft] = 127;
	  	motor[pegRight] = 127;
